...
{
  GoodixCallbackInfo *cb_info;
  /* ponytail: finger-capture bytes per driver_52xd.py:299-302 (trailing 8B match
     FDT exposure block); 01 00.. is calibration-only. */
                                    ...
                                    gpointer user_data)
{
  ...
  goodix_send_protocol (dev, GOODIX_CMD_MCU_SWITCH_TO_FDT_MODE, mode, length,
                        NULL, TRUE, GOODIX_TIMEOUT, FALSE, cb,
                        cb_info);
