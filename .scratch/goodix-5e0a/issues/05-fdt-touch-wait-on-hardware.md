...
**Status:** superseded by 08 — the 0x32 reply is a mode-switch ACK (10ms, not touch-gated), so hardware-FDT gating is abandoned on this firmware. Remaining FDT cleanup folded into 08.
