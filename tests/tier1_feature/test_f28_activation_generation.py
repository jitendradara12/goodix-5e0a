...
(c) These live activation and teardown paths call the generation bump:
...
class TestF28ActivationGeneration(unittest.TestCase):
    ...
    def test_c_live_bump_sites(self):
        """Verify the listed live activation start and teardown sites call bump."""
        with open(GOODIX_C, "r", encoding="utf-8") as f:
            goodix_c = f.read()
